    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String github_url = getResources().getString(R.string.author_website);
...
//            navigationView.setCheckedItem(R.id.nav_task1);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_task1) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new Task2Fragment()).commit();
        } else if (id == R.id.nav_task3) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new Task3Fragment()).commit();
        } else if (id == R.id.nav_task4) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new Task4Fragment()).commit();
        } else if (id == R.id.nav_task5) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new Task5Fragment()).commit();
        }
